...
contract('SupplyChain', function(accounts) {
    ...
    var sku = 1
    var upc = 1
    const imageHash = 'QmdAqTKY5hmPzi13nQhZAu4CRkQ7CqADq2bNZiNgZjQjCK'
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        const imageHashResult = await supplyChain.getImageHash.call(upc);
        
        // // Verify the result set
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(imageHashResult, imageHash, 'Error: Invalid item imageHash')
        ...
        assert.equal(resultBufferTwo[6], 0, 'Error: Invalid item State')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferTwo[2], distributorID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferOne[2], originFarmerID, 'Error: Missing or Invalid originFarmerID')
        assert.equal(resultBufferOne[3], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[4], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[5], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
        ...
        assert.equal(resultBufferThree[2], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferTwo[2], retailerID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferOne[2], originFarmerID, 'Error: Missing or Invalid originFarmerID')
        assert.equal(resultBufferOne[3], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[4], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[5], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
        ...
        assert.equal(resultBufferThree[2], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(resultBufferThree[3], retailerID, 'Error: Missing or Invalid retailerID')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })    
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferTwo[2], consumerID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferOne[2], originFarmerID, 'Error: Missing or Invalid originFarmerID')
        assert.equal(resultBufferOne[3], originFarmName, 'Error: Missing or Invalid originFarmName')
        assert.equal(resultBufferOne[4], originFarmInformation, 'Error: Missing or Invalid originFarmInformation')
        assert.equal(resultBufferOne[5], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
        ...
        assert.equal(resultBufferThree[2], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(resultBufferThree[3], retailerID, 'Error: Missing or Invalid retailerID')
        assert.equal(resultBufferThree[4], consumerID, 'Error: Missing or Invalid consumerID')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[2], consumerID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferTwo[3], productID, 'Error: Missing or Invalid productID')
        assert.equal(resultBufferTwo[4], productNotes, 'Error: Missing or Invalid productNotes')
        assert.equal(resultBufferTwo[5], productPrice, 'Error: Missing or Invalid productPrice')
        assert.equal(resultBufferTwo[6], 7, 'Error: Invalid item State')
    })
    ...
    // 12th Test
    it("Testing smart contract function getImageHash() that allows anyone to fetch item details from blockchain", async() => {
        const supplyChain = await SupplyChain.deployed()
        
        // Retrieve the just now saved item from blockchain by calling function getImageHash()
        const imageHashResult = await supplyChain.getImageHash.call(upc);
